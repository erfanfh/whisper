<div wire:poll>
    @foreach($posts as $post)
        @if($post->user_id != 0)
            <div
                class="d-flex flex-row justify-content-start  my-3 @if((auth()->user()->id == $post->user->id)) justify-content-end @endif">
                ...
                <div
                    ...
                    @else style="background-color: #E5E7EB"
                    @endif class="d-flex flex-column p-4 post-sec col-10 col-md-6">
